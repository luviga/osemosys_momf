...
#            f.write( 'param ' + this_param + ':=\n' )
    ...
    if len(stable_scenarios[scenario_list[scen]]['AnnualEmissionLimit']['value']) == 0:
        g.write('param AnnualEmissionLimit default 99999999999 :=\n;\n') # here we are using no Emission Limit
    ...
    g.write('param ModelPeriodEmissionLimit default 99999999999 :=\n;\n')
    ...
    g.write('param TotalAnnualMaxCapacityInvestment default 99999999999 :=\n;\n')
    ...
    g.write('param TotalTechnologyModelPeriodActivityUpperLimit default 99999999999 :=\n;\n')
