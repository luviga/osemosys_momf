...
technology_list = [
    "DIST_DSL", "DIST_GSL", "DIST_LPG", "DIST_FOI", "PPHDAM", "PPHROR", 
    "PPGEO", "PPWNDON", "PPPVT", "PPPVTHYD", "PPPVD", "PPPVDS", "PPBIO", 
    "DIST_BM", "DIST_BF", "ELE_TRANS", "ELE_DIST", "HYD_G_PROD", "HYD_DIST", 
    "PPDSL", "PPFOI", "T5DSLAGR", "T5ELEAGR", "T5LPGCOM", "T5ELECOM", 
    "T5DSLIND", "T5LPGIND", "T5ELEIND", "T5HYDIND", "T5BMIND", "T5BFIND", 
    "T5FOIIND", "T5ELEPUB", "T5LPGRES", "T5ELERES", "T5ELEEXP", "T4DSL_PRI", 
    "T4GSL_PRI", "T4LPG_PRI", "T4ELE_PRI", "T4DSL_PUB", "T4LPG_PUB", 
    "T4ELE_PUB", "T4HYD_PUB", "T4GSL_PUB", "T4ELE_HEA", "T4DSL_HEA", 
    "T4LPG_HEA", "T4HYD_HEA", "T4DSL_LIG", "T4GSL_LIG", "T4LPG_LIG", 
    "T4ELE_LIG", "TRSUVDSL", "TRSUVGSL", "TRSUVLPG", "TRSUVELE", "TRSUVPHG", 
    "TRSUVPHD", "TRSEDGSL", "TRSEDELE", "TRSEDPHG", "TRMOTGSL", "TRMOTELE", 
    "TRBUSDSL", "TRBUSLPG", "TRBUSELE", "TRBUSHYD", "TRBUSPHD", "TRMBUSDSL", 
    "TRMBUSLPG", "TRMBUSELE", "TRMBUSHYD", "TRMBUSPHD", "TRTAXDSL", 
    "TRTAXGSL", "TRTAXELE", "TRTAXPHG", "TRTAXPHD", "TRXTRAIDSL", 
    "TRXTRAIELE", "TRXTRAIFREELE", "TRYTKDSL", "TRYTKLPG", "TRYTKELE", 
    "TRYTKHYD", "TRYTKPHD", "TRYLFDSL", "TRYLFGSL", "TRYLFLPG", "TRYLFELE", 
    "TRYLFPHG", "TRYLFPHD", "Techs_SUVMIV", "Techs_Sedan", "Techs_Motos", 
    "Techs_Buses", "Techs_Microbuses", "Techs_Taxis", "Techs_Trains", 
    "Techs_Trains_Freight", "Techs_He_Freight", "Techs_Li_Freight", 
    "TRANOMOTBike", "TRANOMOTWalk", "TRANPUB", "TRANRAILINF", "TRANRAILCAR", 
    "TRANE6NOMOT", "TRANRAILFREINF"
]
