...
def disag_lcoe_pp(assorted_data_dicts, time_range_vector):
    lcoe_per_pp = {}
    all_power_plants_techs = ['PPHDAM', 'PPHROR', 'PPGEO', 'PPWNDON', 'PPPVT',
                              'PPPVDS', 'PPPVD', 'PPBIO', 'PPDSL', 'PPFOI']
...
def data_processor(case, base_or_fut, content_all):
    ...
    if accept_all == True:
        ...
        m = {'Strategy':case_strategy_alphabet,
             'Future.ID':case_future, 'adjustment_id':-1 }
        ...
        hyd_2_pp_dict = {'HYD_G_PROD': 'PPPVT'}
...
if __name__ == '__main__':
    ...
    *Abbreviations:*
    ...
    # Control inputs:
    max_x_per_iter = 2  # FLAG: This is an input for parallelization
